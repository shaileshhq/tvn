                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <x-cancel-btn text="Back" route="{{ route('admin.teacher.index') }}" />
                        </div>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('qualification') is-invalid @enderror"
                                    id="qualification" wire:model="qualification" placeholder="Enter Qualification">
                                @error('qualification')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('experience') is-invalid @enderror"
                                    id="experience" wire:model="experience" placeholder="Enter Experience">
                                @error('experience')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea type="text" class="form-control @error('description') is-invalid @enderror" id="short_desc"
