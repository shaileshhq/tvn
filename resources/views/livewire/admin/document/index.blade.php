                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-end flex-wrap text-nowrap">
                                ...
                                <x-add-btn text="New" route="{{route('admin.document.create')}}"/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($list as $key => $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->title }}</td>
                                        <td>
                                            @if($data->category == 'result_academics')
                                                Result and Academics
                                            @else
                                                Documents and Information
                                            @endif
                                        </td>
                                        <td><a href="{{asset('storage/'.$data->document)}}" target="_blank">{{ $data->title }}</a> </td>
                                        <td>
                                        ...
                                        <td>
                                            <x-edit-btn route="{{route('admin.document.edit', $data->id)}}"/>
