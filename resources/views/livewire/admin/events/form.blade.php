                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <x-cancel-btn text="Back" route="{{ route('admin.events.index') }}" />
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="{{ $hidden_id ? 'update()' : 'save()' }}">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="file" wire:model="multi_image" multiple hidden id="imageInput">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
    ...
    @push('scripts')
        <script>
            document.addEventListener('livewire:load', function() {
                ...
                let dropzone = new Dropzone("#dropzoneArea", {
                    url: "#",
                    maxFilesize: 2, // MB
                    addRemoveLinks: true,
                    headers: {
