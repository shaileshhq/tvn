                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-end flex-wrap text-nowrap">
                                ...
                                <x-add-btn text="New" route="{{ route('admin.tc-upload.create') }}" />
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($list as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->tc_no }}</td>
                                        <td><a href="{{ asset('storage/' . $data->file) }}"
                                                target="_blank">View TC</a></td>
                                        <td>
                                        ...
                                        <td>
                                            <x-edit-btn route="{{ route('admin.tc-upload.edit', $data->id) }}" />
