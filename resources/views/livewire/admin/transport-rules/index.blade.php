                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-end flex-wrap text-nowrap">
                                ...
                                <x-add-btn text="New" route="{{route('admin.transport-rules.create')}}"/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @forelse ($list as $data)
                                    <tr>
                                        ...
                                        <td><a href="{{asset('storage/'.$data->document)}}" target="_blank">Download</a> </td>
                                        <td>
                                        ...
                                        <td>
                                            <x-edit-btn route="{{route('admin.transport-rules.edit', $data->id)}}"/>
