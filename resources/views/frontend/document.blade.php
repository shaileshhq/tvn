...
@section('content')
    ...
    <section id="school-timing">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="text-center" style="margin-bottom: 30px; text-transform: uppercase; font-weight: bold;">
                        Mandatory Public Disclosure</h3>
                </div>
            </div>

            <!-- General Information Table -->
            <h4 class="text-uppercase" style="margin-top: 20px; margin-bottom: 20px; font-weight: bold;">A. GENERAL
                INFORMATION</h4>
            ...
            <table class="table table-fm table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/affiliation-letter.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center">2</td>
                        <td>COPIES OF SOCIETIES/TRUST/COMPANY REGISTRATION/RENEWAL CERTIFICATE, AS APPLICABLE</td>
                        <td class="text-center"><a href="{{ asset('storage/document/society-renewal.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/noc.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/deo-certificate.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/building-certificate.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/fire-certificate.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center">7</td>
                        <td>COPY OF THE DEO CERTIFICATE SUBMITTED BY THE SCHOOL FOR AFFILIATION/UPGRADATION/EXTENSION OF
                            AFFILIATIONOR SELF CERTIFICATION BY SCHOOL</td>
                        <td class="text-center"><a href="{{ asset('storage/document/deo-certificate.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/water-health-certificate.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                </tbody>
            ...
            <table class="table table-fm table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/fee-structure.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/academic-calender.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/managing-commitee.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/school-pta.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/last-three-year.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                </tbody>
            ...
            <h5 class="text-uppercase" style="margin-top: 30px; margin-bottom: 20px; font-weight: bold;">RESULT CLASS -X
            </h5>
            <table class="table table-fm table-bordered">
                <thead>
                    <tr>
            ...
            <h5 class="text-uppercase" style="margin-top: 30px; margin-bottom: 20px; font-weight: bold;">RESULT CLASS -XII
            </h5>
            <table class="table table-fm table-bordered">
                <thead>
                    <tr>
            ...
            <h5 class="text-uppercase" style="margin-top: 30px; margin-bottom: 20px; font-weight: bold;">D. STAFF DETAILS –
                TEACHING</h5>
            <table class="table table-fm table-bordered">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/pgt.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/tgt.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ asset('storage/document/prt.pdf') }}"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            Ms. Pooja Patel (Wellness Teacher)<br>
                            Mrs. Shobha Agarwal (Counsellor)
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <h5 class="text-uppercase" style="margin-top: 30px; margin-bottom: 20px; font-weight: bold;">E. SCHOOL
                INFRASTRUCTURE</h5>
            <table class="table table-fm table-bordered">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center">9</td>
                        <td>LINK OF YOU TUBE VIDEO OF THE INSPECTION OF SCHOOL COVERING THE INFRASTRUCTURE OF THE SCHOOL
                        </td>
                        <td class="text-center"><a href="https://youtu.be/8EE7x-HrjrM?si=Eiewbko6HfTuVYGs"
                                class="btn btn-primary btn-sm" target="_blank"><i class="bi bi-link-45deg"></i> View</a>
                        </td>
                    </tr>
                </tbody>
