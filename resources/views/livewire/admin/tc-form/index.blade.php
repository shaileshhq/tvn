                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-end flex-wrap text-nowrap">
                                ...
                                <x-add-btn text="New" route="{{route('admin.tc-form.create')}}"/>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Date of Birth</th>
                                    <th>Result</th>
                                    <th>Qualified Class</th>
                                    <th>Paid All Ammount</th>
                                    <th>Date Issue Certificate</th>
                                    <th>Status</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($list as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <x-edit-btn route="{{route('admin.tc-form.edit', $data->id)}}"/>
